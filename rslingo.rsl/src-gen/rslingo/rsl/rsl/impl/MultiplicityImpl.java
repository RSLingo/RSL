 ...
 * </p>
 * <ul>
 *   <li>{@link rslingo.rsl.rsl.impl.MultiplicityImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiplicityImpl extends MinimalEObjectImpl.Container implements Multiplicity
{
  ...
  {
    return RslPackage.Literals.MULTIPLICITY;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RslPackage.MULTIPLICITY__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RslPackage.MULTIPLICITY__VALUE:
        return getValue();
    }
