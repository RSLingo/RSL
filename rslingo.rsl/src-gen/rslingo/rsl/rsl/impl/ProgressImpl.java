 ...
 * </p>
 * <ul>
 *   <li>{@link rslingo.rsl.rsl.impl.ProgressImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgressImpl extends MinimalEObjectImpl.Container implements Progress
{
  ...
  {
    return RslPackage.Literals.PROGRESS;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RslPackage.PROGRESS__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RslPackage.PROGRESS__VALUE:
        return getValue();
    }
