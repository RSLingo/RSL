 ...
 * </p>
 * <ul>
 *   <li>{@link rslingo.rsl.rsl.impl.PriorityImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PriorityImpl extends MinimalEObjectImpl.Container implements Priority
{
  ...
  {
    return RslPackage.Literals.PRIORITY;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RslPackage.PRIORITY__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RslPackage.PRIORITY__VALUE:
        return getValue();
    }
